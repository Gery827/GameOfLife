...
public class TestGUI {
	...
	// ToString 3:
	// When a cell is alive, its text would be "X", then if the cell is reset, it would no longer be alive, then the text would be ".", in this case, the method should return "X"
